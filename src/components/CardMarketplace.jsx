...
export default function CardMarketplace(props){
    return(
      <div key={props.i}>
        ...
        <div className="p-1 w-full hover:scale-105 cursor-pointer">
          <div className="
          flex flex-row sm:flex-col lg:flex-row content-center justify-between 
          rounded-lg shadow-lg overflow-hidden border bg-white
          h-full">
              <div className='w-2/5 sm:w-full lg:w-2/5 overflow-hidden'>
                  <img className="object-cover h-full w-full"
                  src={props.item.ImagePath} alt=""/>
              </div>    
          
              <div className="flex flex-col justify-between w-3/5 sm:w-full min-w-md"> 
                <div className="p-4">
