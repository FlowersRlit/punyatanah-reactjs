...
const Footer = () => {
  return (
    <div className="bg-orange1 text-center text-white lg:text-left">
      <div className="border-hijau1 mr-6 ml-6 flex items-center justify-center border-b-2 p-6 lg:justify-between">
        <div className="mr-12 hidden lg:block">
          <span>Get connected with us on social networks:</span>
        </div>
        <div className="flex justify-center">
          <NavLink to="#!" className="mr-6 text-white">
            <svg
          ...
          <NavLink
            to="https://github.com/FlowersRlit/punyatanah-project"
      ...
      <div className="bg-hijau1 p-6 text-center">
        ...
        <NavLink className="font-semibold text-white" to="index.html">
          Kelompok 4 - HSBC FSD5
        </NavLink>
      </div>
    </div>
  );
