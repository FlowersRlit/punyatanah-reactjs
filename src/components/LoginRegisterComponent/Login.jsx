...
const Login = () => {
  ...
  return(
    <div className="w-full">
      ...
      <div className="grid grid-rows-2 lg:grid-rows-1 lg:grid-cols-10 lg:my-8 items-center">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-12 my-8 gap-x-4 place-content-end">
          ...
          <button className="btn bg-orange1 border-white text-white hover:bg-orange1 lg:col-span-3">Login</button>
      </div>
    </div>
  )
}
