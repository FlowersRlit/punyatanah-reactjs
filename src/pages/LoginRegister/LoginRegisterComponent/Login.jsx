...
const Login = () => {
  ...
  return (
    <div className="w-full text-black">
      <h1 className="text-4xl font-bold text-black1">Login</h1>

      <div className="grid grid-rows-2 items-center lg:my-8 lg:grid-cols-10 lg:grid-rows-1">
      ...
      <div className="grid grid-cols-12 items-center md:max-lg:mt-4">
      ...
      <div className="my-4 grid grid-rows-1 items-center lg:grid-cols-10 ">
        <div className="relative col-span-10 flex items-center justify-center rounded-lg bg-primary py-3 px-4">
          ...
          <h1 className="text-md col-span-3 font-semibold text-white">
            Sign In With Google
          </h1>
        </div>
      </div>
